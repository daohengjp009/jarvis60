"""Tool: file_word_hasher
Task: Write a function that takes a text file path, finds the most common word in it, and returns that word's SHA-256 hash as hex.
...
def most_common_word_hash(filepath: str) -> str:
    analysis = analyze_text(filepath)
    most_common = analysis['top5'][0]
    return sha256_hex(most_common)
